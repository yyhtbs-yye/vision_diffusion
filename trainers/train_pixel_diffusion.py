...
config_path = "configs/pixel_diffusion_train_64.yaml"  # Updated config path
...
checkpoint_path = "chpt_bkups/pixel_diffusion_64.ckpt"  # Set this to your checkpoint path if needed
